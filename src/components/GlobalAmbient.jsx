    ...
    return (
        <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden bg-[var(--cmd-navy)]">
            ...
            <motion.div 
                ...
                className="absolute inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-[var(--cmd-accent)]/10 to-transparent z-[1] shadow-[0_0_15px_var(--cmd-accent)] opacity-20"
            />
        </div>
    );
};
