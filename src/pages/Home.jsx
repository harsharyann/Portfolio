  ...
  return (
    <main className="min-h-screen pt-32 pb-24 px-6 lg:px-12 relative tech-grid-complex overflow-hidden bg-[var(--cmd-navy)]">
      ...
      <div className="max-w-[1700px] mx-auto w-full flex flex-col gap-10 relative z-10">
        ...
        {/* HERO SECTION */}
        <section ref={heroRef} className="w-full min-h-[450px] lg:h-[500px] flex flex-col">
              ...
              <div className="absolute inset-0 border-[1px] border-white/5 pointer-events-none m-4" />
               <div className="absolute inset-0 flex flex-col items-center justify-center p-6 sm:p-12 text-center pointer-events-none">
                  <motion.div 
                    ...
                    className="relative px-6 sm:px-12 py-8 sm:py-10 pointer-events-auto"
                  >
                 ...
                 <motion.div 
                    ...
                    className="max-w-xl mt-12 pointer-events-auto flex flex-col items-center gap-8"
                  >
                    ...
                    {/* ── CTA BUTTON [VIEW_PROJECTS] ── */}
                      ...
                      >
                         ...
                         <TextScramble text="VIEW_PROJECTS" />
